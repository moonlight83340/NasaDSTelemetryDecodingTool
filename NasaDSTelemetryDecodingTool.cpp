...
//}
//
//Debug to check hexadecimal value
...
//void getPacketDatestampInUtcTimeFromJ2000Time(uint32_t seconds, uint16_t subSeconds) {
...
//int processBinaryFile(const std::string& filePath) {
